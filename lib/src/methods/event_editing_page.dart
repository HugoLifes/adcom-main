...
/*   entre
              if (fromDate.minute >=
                      value.data!.reservas![i].fechaIni!.minute &&
                  fromDate.minute <=
                      value.data!.reservas![i].fechafinEvent!.minute) {
                print('Apartado2');
                setState(() {
                  apartado = true;
                  maxHoras = false;
       ...
       /*        if ((newFromDate == newFechaReserva || newToDate == fechaFinal)) {
              if (fromDate.minute >=
                      value.data!.reservas![i].fechaIni!.minute &&
                  toDate.minute <=
                      value.data!.reservas![i].fechafinEvent!.minute) {
                ...
                if (value.data!.reservas![i].fechaIni!.minute <=
                        fromDate.minute &&
                    value.data!.reservas![i].fechafinEvent!.minute >=
                        toDate.minute) {
                  setState(() {
              ...
              // checa si no esta la fecha inicial entre dos fechas
              if (fromDate.isAfter(value.data!.reservas![i].fechaIni!) ||
                  toDate.isAfter(value.data!.reservas![i].fechafinEvent!)) {
                if (fromDate.minute >
                        value.data!.reservas![i].fechafinEvent!.minute ||
                    toDate.minute < value.data!.reservas![i].fechaIni!.minute) {
                  print('Libre por que esta antes y no chocan');
                  setState(() {
                    apartado = false;
                    maxHoras = false;
                  });
                  ...
                  if (toDate.isAfter(value.data!.reservas![i].fechaIni!) &&
                      toDate
                          .isBefore(value.data!.reservas![i].fechafinEvent!)) {
                    setState(() {
                      apartado = false;
                      maxHoras = false;
                    });
                ...
                //checa si no esta la fecha final entre dos fechas
                if (fromDate.isBefore(value.data!.reservas![i].fechaIni!) ||
                    toDate.isBefore(value.data!.reservas![i].fechafinEvent!)) {
                  if (fromDate.minute >=
                          value.data!.reservas![i].fechafinEvent!.minute &&
                      toDate.minute <=
                          value.data!.reservas![i].fechaIni!.month) {
                    setState(() {
                      apartado = true;
                      maxHoras = false;
                    });
