...
class Checkeo {
  Future<Check?> check(String tiempo, int id) async {
    ...
    Uri url = Uri.parse(
        "http://www.adcom.mx:8080/AdcomBackend/backend/web/index.php?r=adcom/validar-fecha-porveedor");
...
class EnviarCorreo {
  Future<Correo?> sendCorreo(
    ...
    print(coments);
    Uri url = Uri.parse(
        "http://www.adcom.mx:8080/AdcomBackend/backend/web/index.php?r=adcom/envio-correo-servicio");
