...
Future<GetReportes?> getReportes() async {
  try {
    ...
    print(id);
    Uri url = Uri.parse(
        'http://www.adcom.mx:8081/backend/web/index.php?r=adcom/get-reportes');
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: stepColor(index) == null ? Colors.grey : stepColor(index),
                            ),
                            child: headerText(index)== null ? Text('Enviado') : Text('${headerText(index)}'))
                      ],
                    ),
                  ),
                  Column(children: [
