...
ProvedoresId seguimientoFromJson(String str) =>
    ProvedoresId.fromJson(json.decode(str));

String seguimientoToJson(ProvedoresId data) => json.encode(data.toJson());
...
class ProvedoresId {
  ...
  factory ProvedoresId.fromJson(Map<String, dynamic> json) => ProvedoresId(
